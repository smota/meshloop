...
| `quant.search.latency_us.p95` | <= 500.0us | 456.6 us | **PASS** |
| `quant.recall_at_k` | >= 95.0% | 100.0% | **PASS** |
| `orch.txn.wal_commit_ms.p95` | <= 10.0ms | 1.32 ms | **PASS** |
| `conc.wal.write_contention_ms` | <= 15.0ms | 1.36 ms | **PASS** |
| `conc.git_admin.lock_contention_ms` | <= 200.0ms | 66.48 ms | **PASS** |
...
| `smoke.wall_clock_s` | <= 5.0s | 1.57 s | **PASS** |
